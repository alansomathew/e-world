<%-- 
    Document   : Complaint
    Created on : Apr 12, 2022, 2:59:37 PM
    Author     : Admin
--%>
        ...
        <br><br><br><br><br><br><br><br><br><br>
         <% 
            ...
            if (request.getParameter("btn_send") != null) {
                ...
                String ins = "insert into tbl_complaint(complaint_content,complaint_date,complainttype_id,projectcenter_id)values('" + cc + "',curdate(),'" + ct + "','"+session.getAttribute("projectcenterid")+"')";
                //out.println(ins);
